...
public class Level2b extends AppCompatActivity {
    ...
    public static final String APP_PREFERENCES_COUNTER3 = "reckord22";
    ...
    public void back(View v) {
        try {
            Intent inten = new Intent(Level2b.this, MainMenu.class);
            startActivity(inten);
            finish();
        } catch (Exception e) {
        }
    ...
    public void Proverka() {
        ...
        TextView texta = (TextView) findViewById(R.id.z1);
        TextView textb = (TextView) findViewById(R.id.ch2);
        a = (int) Math.round(Math.random() * 890 + 100);
        b = (int) Math.round(Math.random() * 890 + 100);
