...
public class Level1a extends AppCompatActivity {
    ...
    public static final String APP_PREFERENCES_COUNTER1 = "reckord11";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reckord = Settings.getInt(APP_PREFERENCES_COUNTER1, 0);
        TextView reck =(TextView)findViewById(R.id.reckord);
        reck.setText(""+reckord);
        TextView oper = (TextView)findViewById(R.id.operand);
    ...
    public void back(View v) {
        try {
            Intent inten = new Intent(Level1a.this, MainMenu.class);
            startActivity(inten);
            finish();
        } catch (Exception e) {
        }
    ...
    public void Proverka() {
        ...
        TextView texta = (TextView) findViewById(R.id.z1);
        TextView textb = (TextView) findViewById(R.id.ch2);
        a = (int) Math.round(Math.random() * 8 + 2);
        b = (int) Math.round(Math.random() * 8 + 2);
        c = a * b;
        an1 = (a - 1) * b;
        an2 = b * a + 1;
        an3 = a * b - 1;
    ...
    protected void onPause() {
        ...
        editor.putInt(APP_PREFERENCES_COUNTER1, reckord);
        editor.apply();
    }
}