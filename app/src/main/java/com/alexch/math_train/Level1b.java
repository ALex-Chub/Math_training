...
public class Level1b extends AppCompatActivity {
    ...
    public static final String APP_PREFERENCES_COUNTER2 = "reckord12";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reckord = Settings.getInt(APP_PREFERENCES_COUNTER2, 0);
    ...
    public void back(View v) {
        try {
            Intent inten = new Intent(Level1b.this, MainMenu.class);
            startActivity(inten);
            finish();
        } catch (Exception e) {
        }
    ...
    public void Proverka() {
        ...
        TextView texta = (TextView) findViewById(R.id.z1);
        TextView textb = (TextView) findViewById(R.id.ch2);
        c = (int) Math.round(Math.random() * 8 + 2);
    ...
    protected void onPause() {
        ...
        editor.putInt(APP_PREFERENCES_COUNTER2, reckord);
        editor.apply();
    }
}